            ...
            <div class="card">
                <div class="card-header border-0 pt-6">
                    <div class="card-title">
                        <h2>Formulir Edit Role: {{ $role->name }}</h2>
                    </div>
                    </div>
                    ...
                    <form action="{{ route('roles.update', $role->id) }}" method="POST" class="form">
                        ...
                        <div class="row mb-5">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Contoh: surveyor, verifier, admin" value="{{ old('name', $role->name) }}" />
                                @error('name')
                        ...
                        <div class="d-flex justify-content-start">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <span class="indicator-label">Perbarui Role</span>
