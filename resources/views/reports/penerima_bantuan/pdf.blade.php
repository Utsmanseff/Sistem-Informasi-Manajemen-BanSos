...
<head>
    ...
    <style>
        ...
        table.data-table th:nth-child(5), table.data-table td:nth-child(5) { width: 12%; } /* Jenis Bantuan */
        table.data-table th:nth-child(6), table.data-table td:nth-child(6) { width: 10%; } /* Periode */
        table.data-table th:nth-child(7), table.data-table td:nth-child(7) { width: 12%; } /* Status Penerima */
        table.data-table th:nth-child(8), table.data-table td:nth-child(8) { width: 15%; } /* Petugas Ditugaskan */
        table.data-table th:nth-child(9), table.data-table td:nth-child(9) { width: 10%; } /* Tgl Ditetapkan */
...
<body>
    ...
    <h1 class="report-title">LAPORAN PENERIMA BANTUAN</h1>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ Str::title(str_replace('_', ' ', $penerimaBantuan->status_penerima)) }}</td>
            </tr>
            @empty
            <tr>
                <td colspan="9" class="text-center">Tidak ada data penerima bantuan yang ditemukan untuk laporan ini.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
